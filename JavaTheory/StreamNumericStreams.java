...
public class StreamNumericStreams {
    public static void main(String[] args) {
        ...
        // You're tasked with calculating the sum of squares of even numbers within a
        // range. How would you implement this using numeric streams??
        ...
        int sumOfLengths = words.stream().mapToInt(String::length).sum();        
        System.out.println("Sum of lengths of strings: " + sumOfLengths);

        OptionalDouble averageOfLengths = words.stream().mapToInt(String::length).average();
        System.out.println("Average of lengths of strings : " + averageOfLengths.getAsDouble());
    }
